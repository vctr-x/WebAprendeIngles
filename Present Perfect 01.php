...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./Present Perfect 01_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/css">
    <link rel="stylesheet" href="./Present Perfect 01_files/css(1)">
    <link rel="stylesheet" href="./Present Perfect 01_files/css(2)">
    <link rel="stylesheet" href="./Present Perfect 01_files/css(3)">
    <link rel="stylesheet" href="./Present Perfect 01_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Article-List.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Highlight-Clean.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/swiper.min.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Simple-Slider.css">
    <link rel="stylesheet" href="./Present Perfect 01_files/Team-Boxed.css">
...
<body id="page-top" style="height: 850PX;">
    ...
    <div class="text-center border rounded-0 highlight-clean" style="height: 850px;">
        ...
        <h1 style="color: RED;"><strong>Verb Tenses Present Perfect</strong><br></h1>
        <div class="row">
            <div class="col-sm-6 col-md-4 item"><a href=""></a>
                ...
                <div class="col">
                <iframe id="video" width="560" height="315" src="./Present Perfect 01_files/oXqsVMC3tmo.html" style="width: 200.984px;height: 193.016px;" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                </div>

                <h3 class="name" style="margin-top: 20PX;background-color: #ffffff;"><a class="text-center" href="https://drive.google.com/drive/u/1/folders/19E0QlaUJu5QNISmdqc9YhuP8mTAoMUxA" style="color: rgb(13,13,12);font-size: 20px;background-color: rgb(255,255,255);"> <?php echo "$tituloteo$ext"?> </a></h3>
            </div>
            <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                ...
                <h3 class="name"><a class="text-center" href="pPresent Perfect 01.php" style="color: rgb(13,13,12);font-size: 20px;"> Practica con algunos ejercicios.</a></h3>
            </div>
            <div class="col-sm-6 col-md-4 item"><a href=""></a>
                <div class="intro" style="margin-top: 40PX;">
                ...
                <h3 class="name"><a class="text-center" href="ePresent Perfect 01.php" style="color: rgb(13,13,12);font-size: 20px;"> Mide tu capacidad con el cuestionario.</a></h3>
            </div>
        </div>
    ...
    <script src="./Present Perfect 01_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Present Perfect 01_files/bootstrap.min.js.descarga"></script>
    <script src="./Present Perfect 01_files/jquery.easing.min.js.descarga"></script>
    <script src="./Present Perfect 01_files/agency.js.descarga"></script>
    <script src="./Present Perfect 01_files/swiper.jquery.min.js.descarga"></script>
    <script src="./Present Perfect 01_files/Simple-Slider.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="64029" data-lastchange="1605308960601" src="./Present Perfect 01_files/livereload.js.descarga"></script>
