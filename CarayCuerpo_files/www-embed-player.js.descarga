...
J.prototype.U=!0;J.prototype.T=function(){return this.f.toString()};
...
function Jc(a,b){eb(b,function(c,d){c&&"object"==typeof c&&c.U&&(c=c.T());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:Kc.hasOwnProperty(d)?a.setAttribute(Kc[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
function Zg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||T());e[a]=b;a=Dg();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};R("log_sequence_info_on_gel_web")&&d.M&&(a=e.context,b=d.M,Yg[b]=b in Yg?Yg[b]+1:0,a.sequence={index:Yg[b],groupKey:b},d.La&&delete Yg[d.M]);d=d.L;a="";d&&(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),Pg[d.token]=a,a=d.token);d=Og.get(a)||[];Og.set(a,d);d.push(e);c&&(Jg=new c);c=If("web_logging_max_batch")||
100;e=T();d.length>=c?Qg(!0):10<=e-Mg&&(Sg(),Mg=e)}
...
V.all=function(a){return new V(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={P:0};f.P<a.length;f={P:f.P},++f.P)Rh(V.resolve(a[f.P]).then(function(g){return function(h){d[g.P]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})})};
...
function qi(a,b,c){a=a.f.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return pi(a).then(function(d){return Xh(d,c)})}
function ri(a,b){this.request=a;this.cursor=b}
function pi(a){return W(a).then(function(b){return null===b?null:new ri(a,b)})}
...
n.update=function(a){return W(this.cursor.update(a))};function si(a,b,c){function d(){m||(m=new di(e.result,{closed:l}));return m}
...
;var vi=uc||vc;function wi(){var a=/WebKit\/([0-9]+)/.exec(Lb);return!!(a&&600<=parseInt(a[1],10))}
function xi(){var a=/WebKit\/([0-9]+)/.exec(Lb);return!!(a&&602<=parseInt(a[1],10))}
function yi(a){var b=Lb;return b?0<=b.toLowerCase().indexOf(a):!1}
...
closed:c,rb:c,upgrade:this.options.upgrade},e=function(){return Ue(Bi(a.name,a.options.version,d).then(function(f){if(tc){var g=zi(f,a.options);if(void 0!==g){if(tc&&!a.g)return a.g=!0,a["delete"]().then(function(){return e()});
throw new ci(g);}}return f}),function(f){if(f instanceof DOMException?"VersionError"===f.name:"DOMError"in self&&f instanceof DOMError?"VersionError"===f.name:f instanceof Object&&"message"in f&&"An attempt was made to open a database using a lower version than the existing version."===f.message)return Bi(a.name,void 0,Object.assign(Object.assign({},d),{upgrade:void 0}));
c();throw f;})};
...
function Di(){var a={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0,signedIn:!1};return Ci.open().then(function(b){return b.get("databases",a.actualName).then(function(c){if(c?a.actualName!==c.actualName||a.publicName!==c.publicName||a.userIdentifier!==c.userIdentifier||a.signedIn!==c.signedIn||a.clearDataOnAuthChange!==c.clearDataOnAuthChange:1)return gi(b,a)})})}
function Ei(){return Ci.open().then(function(a){return a["delete"]("databases","yt-idb-test-do-not-use")})}
;var Fi;function Gi(){return bc(this,function b(){var c,d;return Ba(b,function(e){switch(e.g){case 1:if(vi&&wi()&&!xi()&&!R("ytidb_allow_on_ios_safari_v8_and_v9")||fc)return e["return"](!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e["return"](!1)}catch(f){return e["return"](!1)}if(R("ytidb_new_supported_check_with_delete"))return e["return"](new Promise(function(f){Ue(Ei().then(function(){f(!0)}),function(){f(!1)})}));
if(R("ytidb_new_supported_check_with_add_and_delete"))return e["return"](new Promise(function(f){Ue(Di().then(function(){return Ei()}).then(function(){f(!0)}),function(){f(!1)})}));
sa(e);return ra(e,Ue(ti("yt-idb-test-do-not-use"),function(){}));
...
function Hi(){if(void 0!==Fi)return Fi;var a=T();Nh=!0;return Fi=new N(function(b){Gi().then(function(c){Nh=!1;Oh("IS_SUPPORTED_COMPLETED",{duration:Math.round(T()-a),isSupported:c});b(c)})})}
;function Ii(){Ce.call(this);this.h=Ji();Ki(this);Li(this)}
v(Ii,Ce);function Ji(){var a=window.navigator.onLine;return void 0===a?!0:a}
...
;function Mi(a,b){b=void 0===b?{}:b;Hi().then(function(){Ii.f||(Ii.f=new Ii);Ii.f.h!==Ji()&&Cf(Error("NetworkStatusManager isOnline does not match window status"));wh(a,b)})}
function Ni(a,b){b=void 0===b?{}:b;Hi().then(function(){wh(a,b)})}
;function Oi(a){var b=this;this.F=null;a?this.F=a:Dh()&&(this.F=Ug());ig(function(){Lh(b)},0,5E3)}
Oi.prototype.isReady=function(){!this.F&&Dh()&&(this.F=Ug());return!!this.F};
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.F.Wa)&&(g=e);var h=a.F.Ya||!1,k=Eh(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.F.innertubeApiVersion+"/"+b;var l={alt:"json"};a.F.Xa&&f.headers.Authorization||(l.key=a.F.innertubeApiKey);var m=gh(""+g+e,l||{},!0);Hi().then(function(p){if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(R("networkless_gel")&&!p||!R("networkless_gel"))var q=Jh(b,
c,k,h);if(q){var r=f.onSuccess,A=f.Ba;f.onSuccess=function(B,U){Kh(q);r(B,U)};
c.Ba=function(B,U){Kh(q);A(B,U)}}}try{R("use_fetch_for_op_xhr")?th(m,f):R("networkless_gel")&&d.retry?(f.method="POST",!d.tb&&R("nwl_send_fast_on_unload")?Ni(m,f):Mi(m,f)):(f.method="POST",f.D||(f.D={}),wh(m,f))}catch(B){if("InvalidAccessError"==B.name)q&&(Kh(q),q=0),Df(Error("An extension is blocking network request."));
else throw B;}q&&ig(function(){Lh(a)},0,5E3)})}
;function Pi(a,b,c){c=void 0===c?{}:c;var d=Oi;Q("ytLoggingEventsDefaultDisabled",!1)&&Oi==Oi&&(d=null);Zg(a,b,d,c)}
...
var Si;var Ti=new O;function Ui(a,b,c,d){c+="."+a;a=Vi(b);d[c]=a;return c.length+a.length}
...
0<=c.stack.indexOf("/mytube.js"))){"ERROR"===b?Ti.O("handleError",c):"WARNING"===b&&Ti.O("handleWarning",c);if(R("kevlar_gel_error_routing")){a=b;a:{g=u(Yi);for(d=g.next();!d.done;d=g.next())if(yi(d.value.toLowerCase())){g=!0;break a}g=!1}if(!g){d={stackTrace:c.stack};c.fileName&&(d.filename=c.fileName);g=c.lineNumber&&c.lineNumber.split?c.lineNumber.split(":"):[];0!==g.length&&(1!==g.length||isNaN(Number(g[0]))?2!==g.length||isNaN(Number(g[0]))||isNaN(Number(g[1]))||(d.lineNumber=Number(g[0]),d.columnNumber=
...
Q("FEXP_EXPERIMENTS")&&(d.experimentIds=Q("FEXP_EXPERIMENTS"));d.kvPairs=[{key:"client.params.errorServiceSignature",value:"msg="+g.g.length+"&cb="+g.f.length}];if(g=c.params)for(f=u(Object.keys(g)),h=f.next();!h.done;h=f.next())h=h.value,d.kvPairs.push({key:"client."+h,value:String(g[h])});g=Q("SERVER_NAME",void 0);f=Q("SERVER_VERSION",void 0);g&&f&&(d.kvPairs.push({key:"server.name",value:g}),d.kvPairs.push({key:"server.version",value:f}));Pi("clientError",{errorMetadata:d,stackTrace:a,logMessage:e});
Qg()}}if(!R("suppress_error_204_logging")){a=c.params||{};b={sb:{a:"logerror",t:"jserror",type:c.name,msg:c.message.substr(0,250),line:c.lineNumber,level:b,"client.name":a.name},D:{url:Q("PAGE_NAME",window.location.href),file:c.fileName},method:"POST"};a.version&&(b["client.version"]=a.version);if(b.D){c.stack&&(b.D.stack=c.stack);g=u(Object.keys(a));for(d=g.next();!d.done;d=g.next())d=d.value,b.D["client."+d]=a[d];if(a=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(g=u(Object.keys(a)),d=
g.next();!d.done;d=g.next())d=d.value,b.D[d]=a[d];a=Q("SERVER_NAME",void 0);g=Q("SERVER_VERSION",void 0);a&&g&&(b.D["server.name"]=a,b.D["server.version"]=g)}wh(Q("ECATCHER_REPORT_HOST","")+"/error_204",b)}Wi.add(c.message);Xi++}}}
...
bj.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,$f(b,function(){g.g=!1;window.botguard?cj(g,c,d,f):(eg(b),Zi(new Yh("Unable to load Botguard","from "+b)))},e)):a&&(e=Mc(document,"SCRIPT"),e.textContent=a,e.nonce=Fa(),document.head.appendChild(e),document.head.removeChild(e),window.botguard?cj(this,c,d,f):Zi(Error("Unable to load Botguard from JS")))};
...
function pj(a){return Q(oj(void 0===a?0:a),void 0)}
...
function rj(){var a=Q("csn-to-ctt-auth-info");a||(a={},P("csn-to-ctt-auth-info",a));return a}
function X(a){a=void 0===a?0:a;var b=Q(nj(a));if(!b&&!Q("USE_CSN_FALLBACK",!0))return null;b||0!=a||(R("kevlar_client_side_screens")||R("c3_client_side_screens")?b="UNDEFINED_CSN":b=Q("EVENT_ID"));return b?b:null}
y("yt_logging_screen.getCurrentCsn",X,void 0);function sj(a,b,c){var d=rj();(c=X(c))&&delete d[c];b&&(d[a]=b)}
function tj(a){return rj()[a]}
y("yt_logging_screen.getCttAuthInfo",tj,void 0);function uj(a,b,c,d){c=void 0===c?0:c;if(a!==Q(nj(c))||b!==Q(oj(c)))if(sj(a,d,c),P(nj(c),a),P(oj(c),b),0==c||R("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&Zg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:ij,clientScreenNonce:a},Oi)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
y("yt_logging_screen.setCurrentScreen",uj,void 0);function vj(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=Xb(window.location.href);g&&f.push(g);g=Xb(d);if(0<=Wa(f,g)||!g&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(f=document.createElement("a"),Rb(f,d),d=f.href),d){g=d.match(Vb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
...
xj.prototype.toString=function(){return this.topic};var yj=z("ytPubsub2Pubsub2Instance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.W;O.prototype.publish=O.prototype.O;O.prototype.clear=O.prototype.clear;y("ytPubsub2Pubsub2Instance",yj,void 0);var zj=z("ytPubsub2Pubsub2SubscribedKeys")||{};y("ytPubsub2Pubsub2SubscribedKeys",zj,void 0);var Aj=z("ytPubsub2Pubsub2TopicToKeys")||{};y("ytPubsub2Pubsub2TopicToKeys",Aj,void 0);var Bj=z("ytPubsub2Pubsub2IsAsync")||{};y("ytPubsub2Pubsub2IsAsync",Bj,void 0);
...
"yt.pubsub2.Data.deserialize(): "+q.message,q;}}catch(q){throw q.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+a.toString()+": "+q.message,q;}b.call(c||window,g)}catch(q){Cf(q)}},Bj[a.toString()]?z("yt.scheduler.instance")?hg(h):S(h,0):h())});
...
return b}
function Ij(a){var b=Dj();b&&("number"===typeof a&&(a=[a]),I(a,function(c){b.unsubscribeByKey(c);delete zj[c]}))}
function Dj(){return z("ytPubsub2Pubsub2Instance")}
;function Jj(a){wj.call(this,1,arguments);this.csn=a}
v(Jj,wj);var Hj=new xj("screen-created",Jj),Kj=[],Mj=Lj,Nj=0;function Oj(a,b,c,d){c={csn:b,parentVe:c.getAsJson(),childVes:Za(d,function(f){return f.getAsJson()})};
d=u(d);for(var e=d.next();!e.done;e=d.next())e=e.value.getAsJson(),(ib(e)||!e.trackingParams&&!e.veType)&&Zi(Error("Child VE logged with no data"));d={L:tj(b),M:b};"UNDEFINED_CSN"==b?Pj("visualElementAttached",c,d):a?Zg("visualElementAttached",c,a,d):Pi("visualElementAttached",c,d)}
function Qj(a,b,c){var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";c={csn:b,ve:c.getAsJson(),gestureType:d};d={L:tj(b),M:b};"UNDEFINED_CSN"==b?Pj("visualElementGestured",c,d):a?Zg("visualElementGestured",c,a,d):Pi("visualElementGestured",c,d)}
...
function Gj(a){if(Kj){for(var b=u(Kj),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,Zg(c.payloadName,c.payload,null,c.options));Kj.length=0}Nj=0}
;function Rj(a,b,c){Oj(R("use_default_events_client")?void 0:Oi,a,b,[c])}
...
wj:37169,xj:21667,yj:16749,zj:18635,Aj:39305,Bj:18046,Cj:53969,Dj:8213,Ej:93926,Fj:102852,Gj:110099,Hj:22678,Ij:69076,Jj:100856,Kj:17736,Lj:3832,Mj:55759,Nj:64031,Oj:93044,Pj:93045,Qj:34388,Rj:17657,Sj:17655,Tj:39579,Uj:39578,Vj:77448,Wj:8196,Xj:11357,Yj:69877,Zj:8197,ak:82039};function Tj(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||lb(b);this.assets=a.assets||{};this.attrs=a.attrs||lb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Tj.prototype.clone=function(){var a=new Tj,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==La(c)?a[b]=lb(c):a[b]=c}return a};function Uj(){M.call(this);this.f=[]}
v(Uj,M);Uj.prototype.u=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.Ja)}M.prototype.u.call(this)};var Vj=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Wj(a){a=a||"";if(window.spf){var b=a.match(Vj);spf.style.load(a,b?b[1]:"",void 0)}else Xj(a)}
function Xj(a){var b=Yj(a),c=document.getElementById(b),d=c&&Lf(c,"loaded");d||c&&!d||(c=Zj(a,b,function(){Lf(c,"loaded")||(Jf(c),Vf(b),S(Sa(Wf,b),0))}))}
...
function Yj(a){var b=Mc(document,"A");Rb(b,new J(a,Eb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ub(a)}
;function ak(a,b,c,d){M.call(this);var e=this;this.m=this.ca=a;this.H=b;this.o=!1;this.api={};this.aa=this.G=null;this.I=new O;Uc(this,Sa(Vc,this.I));this.j={};this.S=this.ba=this.i=this.ja=this.f=null;this.R=!1;this.l=this.B=null;this.da={};this.Ga=["onReady"];this.ia=null;this.ta=NaN;this.Y={};this.h=d;bk(this);this.ea("WATCH_LATER_VIDEO_ADDED",this.bb.bind(this));this.ea("WATCH_LATER_VIDEO_REMOVED",this.cb.bind(this));this.ea("onAdAnnounce",this.Ia.bind(this));this.Ha=new Uj(this);Uc(this,Sa(Vc,
this.Ha));this.Z=0;c?this.Z=S(function(){e.loadNewVideoConfig(c)},0):d&&(ck(this),dk(this))}
v(ak,M);n=ak.prototype;n.getId=function(){return this.H};
n.loadNewVideoConfig=function(a){if(!this.g){this.Z&&(Nf(this.Z),this.Z=0);a instanceof Tj||(a=new Tj(a));this.ja=a;this.f=a.clone();ck(this);this.ba||(this.ba=ek(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=bd(Number(a)||String(a));if(a=this.f.attrs.height)this.m.style.height=bd(Number(a)||String(a));dk(this);this.o&&fk(this)}};
...
function gk(a){var b=!0,c=hk(a);c&&a.f&&(a=ik(a),b=Lf(c,"version")===a);return b&&!!z("yt.player.Application.create")}
...
a.R=!0;b?a.B():($f(ik(a),a.B),(b=a.h?a.h.cssUrl:a.f.assets.css)&&Wj(b),mk(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function hk(a){var b=Ic(a.i);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.i));return b}
function jk(a){if(!a.g){var b=hk(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.R=!1,!lk(a,"html5_remove_not_servable_check_killswitch")&&b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||nk(a)):a.ta=S(function(){jk(a)},50)}}
...
function ok(a,b,c){var d=b[c];return function(){try{return a.ia=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.ia=e,Df(e))}}}
function bk(a){a.o=!1;if(a.aa)for(var b in a.j)a.aa(b,a.j[b]);for(var c in a.Y)Nf(parseInt(c,10));a.Y={};a.G=null;a.aa=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.ea.bind(a);a.api.removeEventListener=a.ib.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Pa.bind(a);a.api.getPlayerType=a.Qa.bind(a);a.api.getCurrentVideoConfig=a.Oa.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Za.bind(a)}
n.Za=function(){return this.o};
n.ea=function(a,b){var c=this,d=ek(this,b);if(d){if(!(0<=Wa(this.Ga,a)||this.j[a])){var e=pk(this,a);this.G&&this.G(a,e)}this.I.subscribe(a,d);"onReady"==a&&this.o&&S(function(){d(c.api)},0)}};
n.ib=function(a,b){if(!this.g){var c=ek(this,b);c&&ef(this.I,a,c)}};
...
function pk(a,b){var c="ytPlayer"+b+a.H;a.j[b]=c;x[c]=function(d){var e=S(function(){if(!a.g){a.I.O(b,d);var f=a.Y,g=String(e);g in f&&delete f[g]}},0);
jb(a.Y,String(e))};
return c}
...
n.cancel=function(){if(this.B){var a=ik(this);fg(a,this.B)}Nf(this.ta);this.R=!1};
n.u=function(){kk(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){Cf(b)}this.da=null;for(var a in this.j)x[this.j[a]]=null;this.ja=this.f=this.api=null;delete this.ca;delete this.m;M.prototype.u.call(this)};
...
function lk(a,b){if(a.h)var c=a.h.serializedExperimentFlags;else a.f&&a.f.args&&(c=a.f.args.fflags);return"true"==dh(c||"")[b]}
;var qk={},rk="player_uid_"+(1E9*Math.random()>>>0);
function sk(a,b,c){var d="player";c=void 0===c?!0:c;var e;"string"===typeof d?e=Ic(d):e=d;d=e;e=rk+"_"+Na(d);var f=qk[e];if(f&&c)return(b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true"))?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new ak(d,e,a,b);qk[e]=f;Vf("player-added",f.api);Uc(f,Sa(tk,f));return f.api}
...
;function yk(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);Uc(this,Sa(Vc,this.f))}
G(yk,M);yk.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
...
v(zk,yk);function Ak(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(Ee(a),d.i))}}
zk.prototype.u=function(){this.i=this.h=null;yk.prototype.u.call(this)};function Bk(a){M.call(this);this.f=a;this.f.subscribe("command",this.Ea,this);this.h={};this.j=!1}
v(Bk,M);n=Bk.prototype;n.start=function(){this.j||this.g||(this.j=!0,Ak(this.f,"RECEIVING"))};
...
n.u=function(){var a=this.f;a.g||ef(a.f,"command",this.Ea,this);this.f=null;for(var b in this.h)Ck(this,b);M.prototype.u.call(this)};function Fk(a,b){Bk.call(this,b);this.i=a;this.start()}
...
v(Gk,M);Gk.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.o)}catch(e){Df(e)}}};
Gk.prototype.u=function(){window.removeEventListener("message",this.m);M.prototype.u.call(this)};function Hk(){var a=this.g=new Gk(!!Q("WIDGET_ID_ENFORCE")),b=D(this.hb,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
...
n.dispose=function(){Hk.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Lk(a,b,c){M.call(this);this.f=a;this.i=c;this.j=vg(window,"message",D(this.l,this));this.h=new zk(this,a,b);Uc(this,Sa(Vc,this.h))}
v(Lk,M);Lk.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
Lk.prototype.u=function(){wg(this.j);this.f=null;M.prototype.u.call(this)};function Mk(){var a=lb(Nk),b;return Ue(new N(function(c,d){a.onSuccess=function(e){nh(e)?c(e):d(new Ok("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return Pe(c)})}
function Ok(a,b,c){H.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
v(Ok,H);function Pk(){this.g=0;this.f=null}
Pk.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Ke(a)?a:Qk(a)):2===this.g&&b?(a=b.call(c,this.f),Ke(a)?a:Rk(a)):this};
...
;function Sk(a){H.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Tk;this.isTimeout=a instanceof Ok&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ve}
v(Sk,H);Sk.prototype.name="BiscottiError";function Tk(){H.call(this,"Biscotti ID is missing from server")}
v(Tk,H);Tk.prototype.name="BiscottiMissingError";var Nk={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Uk=null;
function ah(){if(R("disable_biscotti_fetch_on_html5_clients"))return Pe(Error("Fetching biscotti ID is disabled."));if(R("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!Ec.get("CONSENT","").startsWith("YES+"))return Pe(Error("User has not consented - not fetching biscotti id."));if("1"===fb(yf(),"args","privembed"))return Pe(Error("Biscotti ID is not available in private embed mode"));Uk||(Uk=Ue(Mk().then(Vk),function(a){return Wk(2,a)}));
return Uk}
function Vk(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Tk;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Tk;a=a.id;bh(a);Uk=Qk(a);Xk(18E5,2);return a}
function Wk(a,b){var c=new Sk(b);bh("");Uk=Rk(c);0<a&&Xk(12E4,a-1);throw c;}
function Xk(a,b){S(function(){Ue(Mk().then(Vk,function(c){return Wk(b,c)}),Ja)},a)}
function Yk(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ah()}catch(b){return Pe(b)}}
;function Zk(a){if("1"!==fb(yf(),"args","privembed")){a&&$g();try{Yk().then(function(){},function(){}),S(Zk,18E5)}catch(b){Cf(b)}}}
;var Y=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function $k(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=Ec.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
n=$k.prototype;n.get=function(a,b){al(a);bl(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
n.set=function(a,b){al(a);bl(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
n.remove=function(a){al(a);bl(a);delete Y[a]};
...
function cl(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
...
;var ll={},ml=0;
function nl(a,b,c,d,e){e=void 0===e?"":e;if(a)if(c&&!yi("cobalt")){if(a){a instanceof J||(a="object"==typeof a&&a.U?a.T():String(a),Ib.test(a)?a=new J(a,Eb):(a=String(a),a=a.replace(/(%0A|%0D)/g,""),a=(b=a.match(Hb))&&Gb.test(b[1])?new J(a,Eb):null));a=Fb(a||Kb);if("about:invalid#zClosurez"===a||a.startsWith("data"))a="";else{if(!(a instanceof Ob)){b="object"==typeof a;var f=null;b&&a.na&&(f=a.ka());a=Qb(vb(b&&a.U?a.T():String(a)),f)}a instanceof Ob&&a.constructor===Ob?a=a.f:(La(a),a="type_error:SafeHtml");
...
var wl=ul.performance||ul.mozPerformance||ul.msPerformance||ul.webkitPerformance||new vl;var xl=!1;D(wl.clearResourceTimings||wl.webkitClearResourceTimings||wl.mozClearResourceTimings||wl.msClearResourceTimings||wl.oClearResourceTimings||Ja,wl);function yl(a){var b=zl(a);if(b.aft)return b.aft;a=Q((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
...
function Jl(a,b){Gl[b]=Gl[b]||{count:0};var c=Gl[b];c.count++;c.time=T();a.f||(a.f=ig(function(){var d=T(),e;for(e in Gl)Gl[e]&&6E4<d-Gl[e].time&&delete Gl[e];a&&(a.f=0)},0,5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new Yh("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Zi(c)),!0):!1}
...
function Pl(a){return!!Q("FORCE_CSI_ON_GEL",!1)||R("csi_on_gel")||!!Al(a).useGel}
...
function Sl(a,b,c){var d=zl(c);if(R("use_first_tick")&&Tl(a,c))return d[a];if(!b&&"_"!==a[0]){var e=a;wl.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),wl.mark(e))}e=b||T();d[a]=e;e=Ql(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||T();if(Pl(c)){Fl(c||"").tick[a]=b||T();e=Cl(c);if("_start"===a){var f=Il();Jl(f,"baseline_"+e)||Pi("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else Il().tick(a,e,b);Dl(c);e=!0}else e=!1;if(!e){if(!z("yt.timing."+(c||"")+"pingSent_")&&
(f=Q((c||"")+"TIMING_ACTION",void 0),e=zl(c),z("ytglobal.timing"+(c||"")+"ready_")&&f&&Tl("_start")&&yl(c)))if(Dl(c),c)Ul(c);else{f=!0;var g=Q("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&Ul(c)}Fl(c||"").tick[a]=b||T()}return d[a]}
function Tl(a,b){var c=zl(b);return a in c}
function Ul(a){if(!Pl(a)){var b=zl(a),c=Bl(a),d=b._start,e=Q("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:Q((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=yl(a);var h=zl(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&Bl(a).yt_pvis&&"youtube"===e&&(Rl("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var m in c)"_"!==m.charAt(0)&&(f[m]=c[m]);b.ps=T();m={};e=[];for(var p in b)"_"!==p.charAt(0)&&(k=Math.round(b[p]-d),m[p]=k,e.push(p+"."+k));f.rt=
...
var Vl=window;Vl.ytcsi&&(Vl.ytcsi.info=Rl,Vl.ytcsi.tick=Sl);function Wl(){var a=this;this.i=[];this.j=[];this.f=[];this.A=!1;this.l=[];this.g=this.m=!1;this.o=new Map;R("screen_manager_wait_for_csn")&&(R("web_lifecycles")&&fl[0].push(this.B),Ej("loggingScreenCreated",function(){a.B()}),Ej("clearWaitForNavigationJobs",function(){a.l=[]}))}
function Xl(a,b,c){c=void 0===c?0:c;b.then(function(d){var e,f;a.g&&a.h&&a.h();var g=X(c),h=qj(c);g&&h&&(d.csn=g,(null===(e=d.response)||void 0===e?0:e.trackingParams)&&Oj(a.client,g,h,[lj(d.response.trackingParams)]),(null===(f=d.playerResponse)||void 0===f?0:f.trackingParams)&&Oj(a.client,g,h,[lj(d.playerResponse.trackingParams)]))})}
function Yl(a,b,c,d){if(a.g&&!d)a.i.push([b,c]);else{var e=X(d);c=c||qj(d);e&&c&&Oj(a.client,e,c,[b])}}
function Zl(a,b){var c=void 0===c?0:c;a.o.set(b,c);"UNDEFINED_CSN"===X(c)||a.g||Yl(a,b,void 0,c)}
Wl.prototype.clickCommand=function(a){var b=X();if(!a.clickTrackingParams||!b)return!1;Qj(this.client,b,lj(a.clickTrackingParams));return!0};
function $l(a,b,c){c=void 0===c?{}:c;a.g=!0;a.h=function(){am(a,b,c);var f=qj(c.layer);if(f){for(var g=u(a.i),h=g.next();!h.done;h=g.next())h=h.value,Yl(a,h[0],h[1]||f,c.layer);f=u(a.j);for(g=f.next();!g.done;g=f.next()){h=g.value;g=h[0];var k=h[1];if(a.g)a.j.push([g,k]);else{var l=lj(g);if(h=X())g=a.client,k={csn:h,ve:l.getAsJson(),clientData:k},l={L:tj(h),M:h},"UNDEFINED_CSN"==h?Pj("visualElementStateChanged",k,l):g?Zg("visualElementStateChanged",k,g,l):Pi("visualElementStateChanged",k,l)}}}};
X(c.layer)||a.h();if(c.wa)for(var d=u(c.wa),e=d.next();!e.done;e=d.next())Xl(a,e.value,c.layer);else $i(Error("Delayed screen needs a data promise."))}
function am(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.fb?c.fb:c.layer;var e=X(d);d=qj(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));if(e&&"UNDEFINED_CSN"!==e&&d){var g=a.client,h=!0,k=(h=void 0===h?!1:h)?16:8;k={csn:e,ve:d.getAsJson(),eventType:k};h={L:tj(e),M:e,La:h};"UNDEFINED_CSN"==e?Pj("visualElementHidden",k,h):g?Zg("visualElementHidden",k,g,h):Pi("visualElementHidden",
k,h)}try{var l=a.client;g=f;var m=c.va,p=c.L,q=Mj(),r={csn:q,pageVe:(new kj({veType:b,youtubeData:void 0})).getAsJson()};g&&g.visualElement?r.implicitGesture={parentCsn:g.clientScreenNonce,gesturedVe:g.visualElement.getAsJson()}:g&&Zi(new Yh("newScreen() parent element does not have a VE - rootVe",b));m&&(r.cloneCsn=m);m={L:p,M:q};l?Zg("screenCreated",r,l,m):Pi("screenCreated",r,m);Cj(Hj,new Jj(q));var A=q}catch(B){aj(B,{mk:b,rootVe:d,parentVisualElement:void 0,gk:e,lk:f,va:c.va});$i(B);return}uj(A,
b,c.layer,c.L);a.f[a.f.length-1]&&!a.f[a.f.length-1].csn&&(a.f[a.f.length-1].csn=A||"");R("screen_manager_wait_for_csn")&&(y("midTransition",!1,void 0),Cj("loggingScreenCreated"),a.m=!1);Rl("csn",A);dl.getInstance().clear();a.g=!1;a.h=void 0;b=qj(c.layer);e=u(a.o);for(f=e.next();!f.done;f=e.next())f=u(f.value),A=f.next().value,f.next().value===c.layer&&b&&Yl(a,A,b,c.layer);R("c3_client_side_screens")&&!a.A&&(c=mj(49980),b=mj(49981),F("historyVes",{backButtonVe:c,forwardButtonVe:b}),Zl(a,c),Zl(a,b),
a.A=!0)}
Wl.prototype.B=function(){for(var a=u(this.l),b=a.next();!b.done;b=a.next())b=b.value,b();this.l=[]};var bm=null,cm=null,dm=null,em={};function fm(a){var b=a.id;a=mj(a.ve_type);em[b]=a;b=X();var c=qj();b&&c&&Rj(b,c,a)}
function gm(){var a=bm.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
function hm(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(uj(b,a),a=qj()))for(var c in em){var d=em[c];d&&Rj(b,a,d)}}
function im(a){em[a.id]=lj(a.tracking_params)}
function jm(a){var b=X();a=em[a.id];b&&a&&Qj(R("use_default_events_client")?void 0:Oi,b,a)}
function km(a){a=a.ids;var b=X();if(b)for(var c=0;c<a.length;c++){var d=em[a[c]];if(d){var e=b,f=R("use_default_events_client")?void 0:Oi;d={csn:e,ve:d.getAsJson(),eventType:1};var g={L:tj(e),M:e};"UNDEFINED_CSN"==e?Pj("visualElementShown",d,g):f?Zg("visualElementShown",d,f,g):Pi("visualElementShown",d,g)}}}
;y("yt.setConfig",P,void 0);y("yt.config.set",P,void 0);y("yt.setMsg",Ff,void 0);y("yt.msgs.set",Ff,void 0);y("yt.logging.errors.log",$i,void 0);
y("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);if(!a){var b=Q("PLAYER_VARS",void 0);b&&(a={args:b})}Zk(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=Q("POST_MESSAGE_ORIGIN");window!=window.top&&c&&c!=document.URL&&(a.args.loaderUrl=c);if((c=Q("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){if(!c.serializedForcedExperimentIds){var d=
window.location.href;-1!=d.indexOf("?")?(d=(d||"").split("#")[0],d=d.split("?",2),d=fh(1<d.length?d[1]:d[0])):d={};d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}a=sk(a,c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER,!1)}else a=sk(a);bm=a;a.addEventListener("onScreenChanged",hm);a.addEventListener("onLogClientVeCreated",fm);a.addEventListener("onLogServerVeCreated",im);a.addEventListener("onLogVeClicked",jm);a.addEventListener("onLogVesShown",km);a.addEventListener("onVideoDataChange",
gm);c=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?dm=new Kk(a):Q("ENABLE_POST_API")&&"string"===typeof c&&"string"===typeof b&&(cm=new Lk(window.parent,c,b),dm=new Fk(a,cm.h));mg()},void 0);
var lm=Bf(function(){Sl("ol");var a=$k.getInstance(),b=!!((cl("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Nd(document.body,"exp-invert-logo"))if(c&&!Nd(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Nd(d,"inverted-hdpi")){var e=Ld(d);Md(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Nd(document.body,"inverted-hdpi")&&Od();b!=c&&(b="f"+(Math.floor(119/31)+1),d=cl(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete Y[b]:(c=d.toString(16),Y[b]=c.toString()),a.save());Wl.f||(Wl.f=new Wl);a=Wl.f;c=16623;var f=void 0===f?{}:f;Object.values(Sj).includes(c)||(Zi(new Yh("createClientScreen() called with a non-page VE",c)),c=83769);f.isHistoryNavigation||a.f.push({rootVe:c,key:f.key||""});a.i=[];a.j=[];R("screen_manager_wait_for_csn")&&(a.m||Cj("clearWaitForNavigationJobs"),F("midTransition",!0));f.wa?$l(a,c,f):am(a,c,f)}),mm=Bf(function(){var a=bm;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&dj.dispose();a=0;for(var b=kg.length;a<b;a++){var c=kg[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):Nf(c)}}kg.length=0;eg("//static.doubleclick.net/instream/ad_status.js");lg=!1;P("DCLKSTAT",0);Wc(dm,cm);if(a=bm)a.removeEventListener("onScreenChanged",hm),a.removeEventListener("onLogClientVeCreated",fm),a.removeEventListener("onLogServerVeCreated",im),a.removeEventListener("onLogVeClicked",jm),a.removeEventListener("onLogVesShown",
km),a.removeEventListener("onVideoDataChange",gm),a.destroy();em={}});
window.addEventListener?(window.addEventListener("load",lm),window.addEventListener("unload",mm)):window.attachEvent&&(window.attachEvent("onload",lm),window.attachEvent("onunload",mm));F("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||ej);F("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||fj);F("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||ng);F("yt.player.exports.navigate",z("yt.player.exports.navigate")||vj);
