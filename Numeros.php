...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Numeros</title>
    <link rel="stylesheet" href="./Numeros_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Numeros_files/css">
    <link rel="stylesheet" href="./Numeros_files/css(1)">
    <link rel="stylesheet" href="./Numeros_files/css(2)">
    <link rel="stylesheet" href="./Numeros_files/css(3)">
    <link rel="stylesheet" href="./Numeros_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Numeros_files/Article-List.css">
    <link rel="stylesheet" href="./Numeros_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Numeros_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Numeros_files/Highlight-Clean.css">
    <link rel="stylesheet" href="./Numeros_files/swiper.min.css">
    <link rel="stylesheet" href="./Numeros_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Numeros_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Numeros_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Numeros_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Numeros_files/Projects-Clean.css">
    <link rel="stylesheet" href="./Numeros_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Numeros_files/Simple-Slider.css">
    <link rel="stylesheet" href="./Numeros_files/Team-Boxed.css">
    <link rel="stylesheet" href="./Numeros_files/Team-Clean.css">
...
<body>
        ...
        <div class="container"><a class="navbar-brand" href="#"> <?php echo $Nombre ?> - <?php echo $Nivel ?> </a><button class="navbar-toggler navbar-toggler-right" data-toggle="collapse" data-target="#navbarResponsive" type="button" data-toogle="collapse" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto text-uppercase">
                    <li class="nav-item" role="presentation"><a class="nav-link active js-scroll-trigger" href="#"></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="Nivel basico.php">ACTIVIDADES</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="Foro.html">CONSULTAS</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="NotasBasico.php">NOTAS</a></li>
    ...
    <div class="article-list">
        <div class="container">
            ...
            <h2 class="text-center" style="color: rgb(228,15,15);">The numbers</h2>
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="#"></a>
                    ...
                    </div><iframe width="560" height="315" allowfullscreen="" frameborder="0" src="./Numeros_files/JziMDyQd1Ds.html" style="width: 289.984px;height: 193.016px;"></iframe>
                    <h3 class="name"><a class="text-center" href="https://drive.google.com/drive/u/1/folders/1Ct5cGpB5yddYhQGGInyayWeXEdwUo54S" style="color: rgb(13,13,12);font-size: 20px;"> <?php echo "$tituloteo$ext"?> </a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="#"></a>
                    <div class="intro">
                    ...
                    <h3 class="name"><a class="text-center" href="pnumeros.php" style="color: rgb(13,13,12);font-size: 20px;"> Practica con algunos ejercicios.</a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="#"></a>
                    <div class="intro">
                    ...
                    <h3 class="name"><a class="text-center" href="enumeros.php" style="color: rgb(13,13,12);font-size: 20px;"> Mide tu capacidad con el cuestionario.</a></h3>
                </div>
    ...
    <script src="./Numeros_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Numeros_files/bootstrap.min.js.descarga"></script>
    <script src="./Numeros_files/jquery.easing.min.js.descarga"></script>
    <script src="./Numeros_files/agency.js.descarga"></script>
    <script src="./Numeros_files/swiper.jquery.min.js.descarga"></script>
    <script src="./Numeros_files/Simple-Slider.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="55283" data-lastchange="1605304815252" src="./Numeros_files/livereload.js.descarga"></script>
