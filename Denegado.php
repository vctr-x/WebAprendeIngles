...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./Error_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Error_files/css">
    <link rel="stylesheet" href="./Error_files/css(1)">
    <link rel="stylesheet" href="./Error_files/css(2)">
    <link rel="stylesheet" href="./Error_files/css(3)">
    <link rel="stylesheet" href="./Error_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Error_files/Article-List.css">
    <link rel="stylesheet" href="./Error_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Error_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Error_files/animate.min.css">
    <link rel="stylesheet" href="./Error_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Error_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Error_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Error_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Error_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Error_files/Team-Boxed.css">
...
<body>
    ...
    <div class="highlight-blue" style="background-color: rgb(248,157,50);height: 122px;">
        <div class="container text-center">
            <div class="intro">
                <h2 class="text-center" style="font-size: 44px;">Denegado...</h2>
            </div>
        </div>
    </div>
    <div class="highlight-blue" style="background-color: rgb(248,157,50);">
        <div class="container text-center">
            <div class="intro">
                <p class="text-center" style="color: rgb(13,13,13);font-size: 25px;">Disculpe las molestias pero el nivel en el que se encuantra no es el adecuado...</p>
            </div>
            <div></div>
            <div class="buttons"><a class="btn btn-primary" role="button" href="Niveles.php">Aceptar</a></div>
        </div>
    </div>
    <div class="highlight-blue" style="background-color: rgb(248,157,50);"></div>
    <div class="highlight-blue" style="background-color: rgb(248,157,50);"></div>
    <script src="./Error_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Error_files/bootstrap.min.js.descarga"></script>
    <script src="./Error_files/smart-forms.min.js.descarga"></script>
    <script src="./Error_files/jquery.easing.min.js.descarga"></script>
    <script src="./Error_files/agency.js.descarga"></script>
    <script src="./Error_files/bs-animation.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="53346" data-lastchange="1602726693044" src="./Error_files/livereload.js.descarga"></script>
</body></html>