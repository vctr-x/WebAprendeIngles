...
<body id="page-top" data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
        <div class="container"><a class="navbar-brand" href="#"> <?php echo $Nombre ?> - <?php echo $Nivel ?> </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto text-uppercase">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link js-scroll-trigger active" href="Perfil Estudianate.php">Perfil</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link js-scroll-trigger" href="Foro.html">Consultas</a>
                    </li>
                    <li class="nav-item" role="presentation">
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4"><span class="fa-stack fa-4x"><img src="./Niveles_files/pooos.jpeg" style="width: 90%;"></span>
                    <a class="a" href="Nivel basico.php"> <h4 class="section-heading" > <?php echo $Basico ?> </h4> </a>
                ...
                <div class="col-md-4"><span class="fa-stack fa-4x"><img src="./Niveles_files/mediii.jpeg" style="width: 65%;"></span>
                    <a class="a" href="Nivel Intermedio.php"> <h4 class="section-heading"> <?php echo $Intermedio ?> </h4> </a>
                ...
                <div class="col-md-4"><span class="fa-stack fa-4x"><img src="./Niveles_files/medio pollito.jpeg" style="width: 90%;filter: grayscale(0%);"></span>
                    <a class="a" href="Nivel Avanzado.php"> <h4 class="section-heading"> <?php echo $Avanzado ?> </h4> </a>
