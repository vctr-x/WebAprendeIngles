...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>pantallacontenido - basico</title>
    <link rel="stylesheet" href="./Baño_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Baño_files/css">
    <link rel="stylesheet" href="./Baño_files/css(1)">
    <link rel="stylesheet" href="./Baño_files/css(2)">
    <link rel="stylesheet" href="./Baño_files/css(3)">
    <link rel="stylesheet" href="./Baño_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Baño_files/Article-List.css">
    <link rel="stylesheet" href="./Baño_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Baño_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Baño_files/Highlight-Clean.css">
    <link rel="stylesheet" href="./Baño_files/swiper.min.css">
    <link rel="stylesheet" href="./Baño_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Baño_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Baño_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Baño_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Baño_files/Projects-Clean.css">
    <link rel="stylesheet" href="./Baño_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Baño_files/Simple-Slider.css">
    <link rel="stylesheet" href="./Baño_files/Team-Boxed.css">
    <link rel="stylesheet" href="./Baño_files/Team-Clean.css">
...
<body>
    ...
    <div class="article-list">
        <div class="container">
            ...
            <h2 class="text-center" style="color: rgb(228,15,15);">The bathroom</h2>
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                    ...
                    </div><iframe width="560" height="315" allowfullscreen="" frameborder="0" src="./Baño_files/690ZV3bKHZ4.html" style="width: 289.984px;height: 193.016px;"></iframe>
                ...
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                    ...
                    <h3 class="name"><a class="text-center" href="pbaño.php" style="color: rgb(13,13,12);font-size: 20px;"> Practica con algunos ejercicios.</a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                    <div class="intro">
                    ...
                    <h3 class="name"><a class="text-center" href="ebaño.php" style="color: rgb(13,13,12);font-size: 20px;"> Mide tu capacidad con el cuestionario.</a></h3>
                </div>
    ...
    <script src="./Baño_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Baño_files/bootstrap.min.js.descarga"></script>
    <script src="./Baño_files/jquery.easing.min.js.descarga"></script>
    <script src="./Baño_files/agency.js.descarga"></script>
    <script src="./Baño_files/swiper.jquery.min.js.descarga"></script>
    <script src="./Baño_files/Simple-Slider.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="55283" data-lastchange="1605304676870" src="./Baño_files/livereload.js.descarga"></script>
