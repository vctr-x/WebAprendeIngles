<?php
    ...
    $Apellido_Est=$_POST['Apellido'];
    $Nivel_Est=$_POST['Nivel'];
    $Grado=$_POST['Grado'];
    $Email_Est=$_POST['Email'];
    $Password_Est=$_POST['Password'];
    $Conf_Pass_Est=$_POST['Password-repeat'];

    if($Password_Est!=$Conf_Pass_Est){
        header("location:Error.html");
    }else{
        $sql= "INSERT INTO tbl_estudiante VALUES('$ID_Estudiante',
                                            '$Nombre_Est',
                                            '$Apellido_Est',
                                            '$Nivel_Est',
                                            '$Grado',
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>nuevo</title>
    <link rel="stylesheet" href="./Registro Exitoso_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/css">
    <link rel="stylesheet" href="./Registro Exitoso_files/css(1)">
    <link rel="stylesheet" href="./Registro Exitoso_files/css(2)">
    <link rel="stylesheet" href="./Registro Exitoso_files/css(3)">
    <link rel="stylesheet" href="./Registro Exitoso_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Article-List.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/animate.min.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Registro Exitoso_files/Team-Boxed.css">
...
<body>
    <div class="highlight-blue" style="background-color: rgb(248,157,50);height: 56px;">
        <div class="container text-center">
            <div class="intro"></div>
        </div>
    </div>
    <div class="highlight-blue" style="background-color: rgb(248,157,50);height: 122px;">
        <div class="container text-center">
            <div class="intro">
                <h2 class="text-center" style="font-size: 44px;">Registro exitoso</h2>
            </div>
        </div>
    </div>
    <div class="highlight-blue" style="background-color: rgb(248,157,50);">
        <div class="container text-center">
            <div class="intro">
                <p class="text-center" style="color: rgb(13,13,13);font-size: 25px;">Usuario creado de forma exitosa</p>
            </div><i class="fa fa-check"></i>
            <div></div>
            <div class="buttons"><a class="btn btn-primary" role="button" href="Login.html">Aceptar</a></div>
        </div>
    </div>
    <div class="highlight-blue" style="background-color: rgb(248,157,50);"></div>
    <div class="highlight-blue" style="background-color: rgb(248,157,50);"></div>
    <script src="./Registro Exitoso_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Registro Exitoso_files/bootstrap.min.js.descarga"></script>
    <script src="./Registro Exitoso_files/smart-forms.min.js.descarga"></script>
    <script src="./Registro Exitoso_files/jquery.easing.min.js.descarga"></script>
    <script src="./Registro Exitoso_files/agency.js.descarga"></script>
    <script src="./Registro Exitoso_files/bs-animation.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="53346" data-lastchange="1602707640850" src="./Registro Exitoso_files/livereload.js.descarga"></script>
</body>
</html>
            <?php
        }
