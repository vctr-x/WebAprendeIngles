...
<!DOCTYPE html>
<!-- saved from url=(0024)http://192.168.1.2:8000/ -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
    <title>Comparativo and Superlativo</title>
    <link rel="stylesheet" href="./Comparativos_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Comparativos_files/css">
    <link rel="stylesheet" href="./Comparativos_files/css(1)">
    <link rel="stylesheet" href="./Comparativos_files/css(2)">
    <link rel="stylesheet" href="./Comparativos_files/css(3)">
    <link rel="stylesheet" href="./Comparativos_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Comparativos_files/Article-List.css">
    <link rel="stylesheet" href="./Comparativos_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Comparativos_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Comparativos_files/Highlight-Clean.css">
    <link rel="stylesheet" href="./Comparativos_files/swiper.min.css">
    <link rel="stylesheet" href="./Comparativos_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Comparativos_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Comparativos_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Comparativos_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Comparativos_files/Projects-Clean.css">
    <link rel="stylesheet" href="./Comparativos_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Comparativos_files/Simple-Slider.css">
    <link rel="stylesheet" href="./Comparativos_files/Team-Boxed.css">
    <link rel="stylesheet" href="./Comparativos_files/Team-Clean.css">
...
<body>
        ...
        <div class="container"><a class="navbar-brand"> <?php echo $Nombre ?> - <?php echo $Nivel ?> </a><button class="navbar-toggler navbar-toggler-right" data-toggle="collapse" data-target="#navbarResponsive" type="button" data-toogle="collapse" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto text-uppercase">
                    <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="Nivel Intermedio.php">ACTIVIDADES</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="Proceso.html">CONSULTAS</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="NotasIntermedio.php">NOTA</a></li>
    ...
    <div class="article-list">
        <div class="container">
            ...
            <h2 class="text-center" style="color: rgb(228,15,15);">Comparative and superlative</h2>
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.2:8000/#"></a>
                    <div class="intro">
                    ...
                    </div><iframe width="560" height="315" allowfullscreen="" frameborder="0" src="./Comparativos_files/M_DixVADeNs.html" style="width: 289.984px;height: 193.016px;"></iframe><iframe width="560" height="315" allowfullscreen="" frameborder="0" src="./Comparativos_files/OzDp4J5uRDo.html" style="width: 289.984px;height: 193.016px;"></iframe>
                    <h3 class="name"><a class="text-center" href="" style="color: rgb(13,13,12);font-size: 20px;"> <?php echo "$tituloteo$ext"?> </a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.2:8000/#"></a>
                    <div class="intro">
                    ...
                    <h3 class="name"><a class="text-center" href="pcomparativos.php" style="color: rgb(13,13,12);font-size: 20px;"> Practica con algunos ejercicios.</a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.2:8000/#"></a>
                    <div class="intro">
                        <h2 class="text-center">Evaluaciones</h2>
                        <p class="text-center">Resuelve todas&nbsp;<br>las evaluaciones&nbsp;que se le brindan en las siguientes direcciones.<br><br></p>
                    </div>
                    <h3 class="name"><a class="text-center" href="ecomparativos.php" style="color: rgb(13,13,12);font-size: 20px;"> Mide tu capacidad con el cuestionario.</a></h3>
                </div>
                <div class="col text-right d-xl-flex justify-content-xl-end">
                    <div class="btn-group" role="group"><a class="btn btn-primary active text-right d-xl-flex justify-content-xl-end" role="button" href="Nivel Intermedio.php">Volver</a></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="./Comparativos_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Comparativos_files/bootstrap.min.js.descarga"></script>
    <script src="./Comparativos_files/jquery.easing.min.js.descarga"></script>
    <script src="./Comparativos_files/agency.js.descarga"></script>
    <script src="./Comparativos_files/swiper.jquery.min.js.descarga"></script>
    <script src="./Comparativos_files/Simple-Slider.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="51123" data-lastchange="1607096829104" src="./Comparativos_files/livereload.js.descarga"></script>
</body></html>