...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./Deportes_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Deportes_files/css">
    <link rel="stylesheet" href="./Deportes_files/css(1)">
    <link rel="stylesheet" href="./Deportes_files/css(2)">
    <link rel="stylesheet" href="./Deportes_files/css(3)">
    <link rel="stylesheet" href="./Deportes_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Deportes_files/Article-List.css">
    <link rel="stylesheet" href="./Deportes_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Deportes_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Deportes_files/Highlight-Clean.css">
    <link rel="stylesheet" href="./Deportes_files/swiper.min.css">
    <link rel="stylesheet" href="./Deportes_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Deportes_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Deportes_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Deportes_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Deportes_files/Projects-Clean.css">
    <link rel="stylesheet" href="./Deportes_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Deportes_files/Simple-Slider.css">
    <link rel="stylesheet" href="./Deportes_files/Team-Boxed.css">
    <link rel="stylesheet" href="./Deportes_files/Team-Clean.css">
...
<body>
    ...
    <div class="article-list">
        <div class="container">
            ...
            <h2 class="text-center" style="color: rgb(228,15,15);">Sports</h2>
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                    ...
                    </div><iframe width="560" height="315" allowfullscreen="" frameborder="0" src="./Deportes_files/-QRkZd9k8jg.html" style="width: 289.984px;height: 193.016px;"></iframe>
                    <h3 class="name"><a class="text-center" href="https://drive.google.com/drive/u/1/folders/1eh40umyLcjvdO3G17wLP_VnMIJmMW3Y9" style="color: rgb(13,13,12);font-size: 20px;"> <?php echo "$tituloteo$ext"?> </a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                    <div class="intro">
                    ...
                    <h3 class="name"><a class="text-center" href="pdeportes.php" style="color: rgb(13,13,12);font-size: 20px;"> Practica con algunos ejercicios.</a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                    <div class="intro">
                    ...
                    <h3 class="name"><a class="text-center" href="epeportes.php" style="color: rgb(13,13,12);font-size: 20px;"> Mide tu capacidad con el cuestionario.</a></h3>
                </div>
    ...
    <script src="./Deportes_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Deportes_files/bootstrap.min.js.descarga"></script>
    <script src="./Deportes_files/jquery.easing.min.js.descarga"></script>
    <script src="./Deportes_files/agency.js.descarga"></script>
    <script src="./Deportes_files/swiper.jquery.min.js.descarga"></script>
    <script src="./Deportes_files/Simple-Slider.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="55283" data-lastchange="1605304692232" src="./Deportes_files/livereload.js.descarga"></script>
</body></html>