<?php
    ...
    $ID_Docente =$_POST['ID'];
    $Nombre_Doc=$_POST['Nombre'];
    $Apellido_Doc=$_POST['Apellido'];
    $Email_Doc=$_POST['Email'];
    $Password_Doc=$_POST['Password'];
    $ConfPass_Doc=$_POST['Password-repeat'];

    if($Password_Doc!=$ConfPass_Doc){
        header("location:Error.html");
    }else{
        $sql= "INSERT INTO tbl_docente VALUES('$ID_Docente',
                                            '$Nombre_Doc',
                                            '$Apellido_Doc',
                                            '$Email_Doc',
                                            '$Password_Doc',
