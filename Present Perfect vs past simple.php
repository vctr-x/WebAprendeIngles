<?php
    ...
    $sqlT0001= "SELECT * FROM tbl_Recurso WHERE ID_Recurso = 'RA_003'";
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Present Perfect vs past simple</title>
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/css(1)">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/css(2)">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/css(3)">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Article-List.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Highlight-Clean.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/swiper.min.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Simple-Slider.css">
    <link rel="stylesheet" href="./Present Perfect vs past simple_files/Team-Boxed.css">
...
<body id="page-top" style="height: 850PX;">
    ...
    <div class="text-center border rounded-0 highlight-clean" style="height: 850px;">
        ...
        <h1 style="color: RED;"><strong>Present perfect vs. Past simple</strong><br></h1>
        <div class="row">
...
<iframe id="video" width="560" height="315" src="./Present Perfect vs past simple_files/492k3Qpr5T8.html" style="width: 200.984px;height: 193.016px;" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
</div>
                <h3 class="name" style="margin-top: 20PX;background-color: #ffffff;"><a class="text-center" href="https://drive.google.com/drive/u/1/folders/18AmvWzpy7Juz1EKTEtR3vP7khonCS4P1" style="color: rgb(13,13,12);font-size: 20px;background-color: rgb(255,255,255);"> <?php echo "$tituloteo$ext"?> </a></h3>
            </div>
            <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                ...
                <h3 class="name" style="margin-top: 241PX;background-color: #ffffff;"><a class="text-center" href="pPresent Perfect vs past simple.html" style="color: rgb(13,13,12);font-size: 20px;background-color: #ffffff;"> Practica con algunos ejercicios.</a></h3>
            </div>
            <div class="col-sm-6 col-md-4 item"><a href="http://192.168.1.13:8000/#"></a>
                <div class="intro" style="margin-top: 40PX;">
                ...
                <h3 class="name" style="margin-top: 244PX;background-color: #ffffff;"><a class="text-center" href="ePresent Perfect vs past simple.html" style="color: rgb(13,13,12);font-size: 20px;background-color: #ffffff;"> Mide tu capacidad con el cuestionario.</a></h3>
            </div>
        </div>
    ...
    <script src="./Present Perfect vs past simple_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Present Perfect vs past simple_files/bootstrap.min.js.descarga"></script>
    <script src="./Present Perfect vs past simple_files/jquery.easing.min.js.descarga"></script>
    <script src="./Present Perfect vs past simple_files/agency.js.descarga"></script>
    <script src="./Present Perfect vs past simple_files/swiper.jquery.min.js.descarga"></script>
    <script src="./Present Perfect vs past simple_files/Simple-Slider.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="64029" data-lastchange="1605309103448" src="./Present Perfect vs past simple_files/livereload.js.descarga"></script>
