...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Colores</title>
    <link rel="stylesheet" href="./Colores_files/bootstrap.min.css">
    <link rel="stylesheet" href="./Colores_files/css">
    <link rel="stylesheet" href="./Colores_files/css(1)">
    <link rel="stylesheet" href="./Colores_files/css(2)">
    <link rel="stylesheet" href="./Colores_files/css(3)">
    <link rel="stylesheet" href="./Colores_files/font-awesome.min.css">
    <link rel="stylesheet" href="./Colores_files/Article-List.css">
    <link rel="stylesheet" href="./Colores_files/Features-Boxed.css">
    <link rel="stylesheet" href="./Colores_files/Highlight-Blue.css">
    <link rel="stylesheet" href="./Colores_files/Highlight-Clean.css">
    <link rel="stylesheet" href="./Colores_files/swiper.min.css">
    <link rel="stylesheet" href="./Colores_files/Login-Form-Clean-1.css">
    <link rel="stylesheet" href="./Colores_files/Login-Form-Clean.css">
    <link rel="stylesheet" href="./Colores_files/Login-Form-Dark.css">
    <link rel="stylesheet" href="./Colores_files/Navigation-Clean.css">
    <link rel="stylesheet" href="./Colores_files/Projects-Clean.css">
    <link rel="stylesheet" href="./Colores_files/Registration-Form-with-Photo.css">
    <link rel="stylesheet" href="./Colores_files/Simple-Slider.css">
    <link rel="stylesheet" href="./Colores_files/Team-Boxed.css">
    <link rel="stylesheet" href="./Colores_files/Team-Clean.css">
...
<body>
    ...
    <div class="article-list">
        <div class="container">
            ...
            <h2 class="text-center" style="color: rgb(228,15,15);">The colors</h2>
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="#"></a>
                    ...
                    </div><iframe width="560" height="315" allowfullscreen="" frameborder="0" src="./Colores_files/c6BVOQfgMP8.html" style="width: 289.984px;height: 193.016px;"></iframe>
                    <h3 class="name"><a class="text-center" href="https://drive.google.com/drive/u/1/folders/1i3ygi1uD1a9HhdksnLIPsShvd5k9WKuC" style="color: rgb(13,13,12);font-size: 20px;"> <?php echo "$tituloteo$ext"?> </a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="#"></a>
                    <div class="intro">
                    ...
                    <h3 class="name"><a class="text-center" href="pcolores.php" style="color: rgb(13,13,12);font-size: 20px;"> Practica con algunos ejercicios.</a></h3>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="#"></a>
                    <div class="intro">
                    ...
                    <h3 class="name"><a class="text-center" href="ecolores.php" style="color: rgb(13,13,12);font-size: 20px;"> Mide tu capacidad con el cuestionario.</a></h3>
                </div>
    ...
    <script src="./Colores_files/jquery-3.3.1.min.js.descarga"></script>
    <script src="./Colores_files/bootstrap.min.js.descarga"></script>
    <script src="./Colores_files/jquery.easing.min.js.descarga"></script>
    <script src="./Colores_files/agency.js.descarga"></script>
    <script src="./Colores_files/swiper.jquery.min.js.descarga"></script>
    <script src="./Colores_files/Simple-Slider.js.descarga"></script>
    <script id="bs-live-reload" data-sseport="55283" data-lastchange="1605304397162" src="./Colores_files/livereload.js.descarga"></script>
